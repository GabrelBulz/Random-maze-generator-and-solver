...
namespace Maze
{
    class Cell_Depth
    {
        ...
        public Cell_Depth(int a, int b)
        {
            ...
            added_by = new KeyValuePair<int, int>(-1, -1);
        }
        ...
        public KeyValuePair<int, int>[] get_neighbor_arr()
        {
